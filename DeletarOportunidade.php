...
if(isset($txtConteudo["id"])){
    ...
    $sql = $sql." WHERE idOportunidades = '".$varId."'";
...
<head>
    ...
    <title>excluirOportunidade</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
    <link rel="stylesheet" href="index.css">
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
</head>
<body>
<form class="formulario" action="excluirOportunidade.php" method="post">
        <input type="hidden" name="id" value="<?php print $id ?>">

        
        <label class="label"style="color: #f1f1f1; text-align: center;">Deseja Realmente Deletar a Oportunidade<p style="color: #c80d0d; text-align: center;"><?php print $nome ?></p></label>
        <br>
            <br>
            <br>
        <div class="d-grid gap-2">
            <input type="submit" value="Excluir" name="btSalva" class="btn btn-danger">
            <input value="Cancelar" class="btn btn-primary" onclick="window.location.href='oportunidades.php'"><br>
        </div>
    </form>
</body>
</html>